    ...
    for day in range(1, 31):
        ...
        for _, row in day_matches.iterrows():
            ...
            if h_team in team_stats and a_team in team_stats and day > 3:
                ...
                if h_rank <= 4 and a_rank <= 4 and h_streak_type == 'L' and h_streak_len == 1 and a_streak_type == 'W' and a_streak_len == 6:
...
if df_snap.empty:
    ...
    print(f"Total occurrences of 'Top 4 Streak Snap': {len(df_snap)}")
