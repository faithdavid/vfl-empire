    ...
    for day in range(1, 31):
        ...
        for _, row in day_matches.iterrows():
            ...
            if h_team in team_stats and a_team in team_stats and day > 3:
                ...
                # Bottom 4 Home (L5) vs Bottom 4 Away (L1)
                if h_rank > 12 and a_rank > 12 and h_streak_type == 'L' and h_streak_len == 5 and a_streak_type == 'L' and a_streak_len == 1:
...
if df_snap.empty:
    ...
    print(f"Total occurrences of 'Bottom 4 Stagnation': {len(df_snap)}")
